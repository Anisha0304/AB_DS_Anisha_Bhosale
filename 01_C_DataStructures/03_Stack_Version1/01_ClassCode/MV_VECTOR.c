...
void error_checking(const int assert_condition,const char* assert_condition_str,const char* file_name,const int line no,const int error_condition,const char* error_str);

//Macros

#define ERROR_CHECKING(assert-condition,error-condition,error_str)	{									\
...
{
ERROR_CHECKING(NULL != pvector,NULL ==pvector,"ERROR:Vector Not found\n");
...
ERROR_CHECKING(NULL != pvector->array,1,NULL);
}
...
{
ERROR_CHECKING(NULL != pvector,NULL == pvector || 0 == pvector->nr_of_elements,"ERROR:Vector Not found\n");
...
{
ERROR_CHECKING(NULL != pvector,NULL == pvector || 0 == pvector->nr_of_elements,"ERROR: Vector Not found\n");
ERROR_CHECKING(1,index >= pvector->nr_of_elements,"ERROR: Index out of bound.\n" );
...
{
ERROR_CHECKING(NULL != ppvector,NULL == ppvector,"ERROR: Vector Not found\n");
