...
int main(void)
{
	...
	fprintf(stdout, "After List insert At Particular index:\n");
	mv_sll_print_forward(plist, print_long_data);
	...
	fprintf(stdout, "After List Remove Data At:\n");
	mv_sll_print_forward(plist, print_long_data);
	...
	fprintf(stdout, "After List Remove Data Before:\n");
	mv_sll_print_forward(plist, print_long_data);
	...
	fprintf(stdout, "After List Remove Data After:\n");
	mv_sll_print_forward(plist, print_long_data);
